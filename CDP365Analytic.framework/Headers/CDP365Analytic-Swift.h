...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CDP365Analytic",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

enum ANLogLevel : NSInteger;

SWIFT_PROTOCOL("_TtP14CDP365Analytic8ANLogger_")
@protocol ANLogger
- (void)log:(SWIFT_NOESCAPE NSString * _Nonnull (^ _Nonnull)(void))message with:(enum ANLogLevel)level file:(NSString * _Nonnull)file function:(NSString * _Nonnull)function line:(NSInteger)line;
@end


/// This Logger loggs every message to the console with a <code>print</code> statement.
SWIFT_CLASS("_TtC14CDP365Analytic15ANDefaultLogger")
@interface ANDefaultLogger : NSObject <ANLogger>
- (nonnull instancetype)initWithMinLevel:(enum ANLogLevel)minLevel OBJC_DESIGNATED_INITIALIZER;
- (void)log:(SWIFT_NOESCAPE NSString * _Nonnull (^ _Nonnull)(void))message with:(enum ANLogLevel)level file:(NSString * _Nonnull)file function:(NSString * _Nonnull)function line:(NSInteger)line;
...
SWIFT_CLASS("_TtC14CDP365Analytic14CDP365Analytic")
@interface CDP365Analytic : NSObject
+ (void)configure;
+ (void)logEventWithScreenName:(NSString * _Nonnull)screenName;
+ (void)logEventWithCategoryName:(NSString * _Nonnull)categoryName actionName:(NSString * _Nonnull)actionName items:(NSArray<NSDictionary *> * _Nullable)items extra:(NSDictionary * _Nullable)extra dimension:(NSArray<NSDictionary *> * _Nullable)dimension;
...
SWIFT_CLASS("_TtC14CDP365Analytic10ITBaseView")
...
@interface ITBaseView (SWIFT_EXTENSION(CDP365Analytic))
- (void)layoutSubviews;
@end
...
SWIFT_CLASS("_TtC14CDP365Analytic20ITCornerRoundingView")
...
SWIFT_CLASS("_TtC14CDP365Analytic22ITKeyboardTrackingView")
...
SWIFT_CLASS("_TtC14CDP365Analytic13ITMessageView")
...
@interface ITMessageView (SWIFT_EXTENSION(CDP365Analytic))
...
SWIFT_CLASS("_TtC14CDP365Analytic18ITPhysicsAnimation")
...
SWIFT_CLASS("_TtC14CDP365Analytic14ITReachability")
@interface ITReachability : NSObject
...
SWIFT_CLASS("_TtC14CDP365Analytic20ITSwiftMessagesSegue")
...
@interface ITSwiftMessagesSegue (SWIFT_EXTENSION(CDP365Analytic)) <UIViewControllerTransitioningDelegate>
- (id <UIViewControllerAnimatedTransitioning> _Nullable)animationControllerForPresentedController:(UIViewController * _Nonnull)presented presentingController:(UIViewController * _Nonnull)presenting sourceController:(UIViewController * _Nonnull)source SWIFT_WARN_UNUSED_RESULT;
- (id <UIViewControllerAnimatedTransitioning> _Nullable)animationControllerForDismissedController:(UIViewController * _Nonnull)dismissed SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC14CDP365Analytic20ITTopBottomAnimation")
...
SWIFT_CLASS("_TtC14CDP365Analytic22ITWindowViewController")
